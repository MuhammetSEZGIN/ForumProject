        ...
        <form method="POST" action="{{route("editArticle", ['id'=>$article->articleID])}}" id="identifier">
            ...
            <div class="textContainer">
                <div class="input-group input-group-lg">
                    ...
                    <input type="text" class="form-control" value="{{$article->title}}" name="title" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                </div>
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" id="inputGroupSelect01" name="categoryID">
                        <option selected value="{{$article->category[0]->categoryID}}">{{$article->category[0]->categoryName}}</option>
                ...
                <input type="hidden"  name="authorID" value="{{\Illuminate\Support\Facades\Auth::id()}}">
